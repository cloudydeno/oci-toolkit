// SubtleCrypto cannot stream, so we vendor this pure JS impl instead.
// Original URL: https://deno.land/std@0.160.0/hash/sha256.ts
// The std project later dropped this implementation in favor of a WebAssembly binary.
...
export type Message = string | number[] | Uint8Array;
